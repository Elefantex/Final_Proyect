...
function CalcetinesAdmin() {
    ...
    const Borrar = async (c) => {
        ...
        await deleteDoc(doc(db, "Calcetines", c))
    }
            ...
            <div class="proyectar">
                ...
                {lista.map((c) => (
                    <div class="borde" key={c.id}>
                        <div>
                            <div class="item-dividir" ><div><h3> <b>{c.id}</b> <FontAwesomeIcon icon={faSocks}></FontAwesomeIcon></h3><h4>Colour: <b>{c.color}</b></h4><h5><b>{c.precio}€</b></h5>
                            </div>
                                <div>
...
export default CalcetinesAdmin;