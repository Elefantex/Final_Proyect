...
function Perfil() {
    ...
    return (
        <>
            <div>{lista2.length == 0 ? <div class="CajaLogin">
                    ...
                    {lista2.map((c) => (
                        <div key={c.id}>
                            <h2>
                                ...
                                <input type="text"  value={c.apellidos}/><button >editar</button>
                                <div>
                                    <b> Ciudad: </b>{c.ciudad}
                                </div>
                                <div>
            ...
            <button onClick={() => window.location.href = "/editarPerfil"}>Editar datos</button>
