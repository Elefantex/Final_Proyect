...
function Perfil() {
    ...
    const [ciudadPrueba, setCiudadPrueba] = useState("")
    const [paisPrueba, setPaisPrueba] = useState("")
    ...
    const [apellidosPrueba, setApellidosPrueba] = useState("")

    const [zipcode, setZipCode] = useState("")
    const [zipcodePrueba, setZipcodePrueba] = useState("")
    const [direccionPostal, setDireccionPostal] = useState("")
    const [direccionPostalPrueba, setDireccionPostalPrueba] = useState("")
    useEffect(() => {
                        ...
                        <div class="form-floating">
                            <div class="DatosLogin">
                                <form action="" onSubmit={EnviarPerfil}>
                                    ...
                                    <button type="submit" class="btn btn-outline-light">Upload profile</button>
                        ...
                        {lista2.map((c) => (
                            <div key={c.id}>
                                <h2>
                                    ...
                                    <div>
                                        <b>  Phone: </b>{c.telefono}
                                    </div>
                                    <div>
                                        <b>  Address: </b>{c.direccionPostal}
                                    </div>
                                    <div>
                                        <b> Eircode:</b> {c.zipcode}
                                    </div>
                                </h2>

                            </div>
                        ))}
                        <button onClick={() => window.location.href = "/editarPerfil"}>Edit profile</button>
                    </div>
