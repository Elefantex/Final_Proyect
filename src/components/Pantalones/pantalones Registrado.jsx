                ...
                {lista.map((c) => (
                    <div class="borde" key={c.id}>
                            ...
                            <div class="item-dividir" ><div><h3> <b>{c.id}</b> <GiTrousers/></h3><h4>De color: <b>{c.color}</b></h4><h5><b>{c.precio}€</b></h5>
                                ...
                                <div>
                                    <button onClick={() => agregarItem(c)} class="btn btn-primary boton-pequeno"><h5 class="centrar">Añadir a la cesta <FaShoppingBasket className="green" /></h5></button>
                                </div>
...
export default PantalonesRegistrado;